...
#         distritoAuxiliar = DistritoAuxiliar(
#             item2.id, item2.distrito, resumen.ciudad, resumen.calidadAVG)
...
#                 distrito = Distrito(item2.id, item2.distrito,
#                                     item.ciudad, item.calidadAVG, datos)
...
#                     distritoEnfocado = DistritoEnfocado(item2.id, item.ciudad, item2.distrito, item3.humedad,
#                                                         item3.temperatura, item3.concentracion, item3.hora, item3.fecha, item.calidadAVG)
...
#         for item2 in ubicaciones:
#             item3 = Dato.objects.filter(distrito=item2.id).last()
#             distritoMapa = DistritoMapa(item2.id, item.ciudad, item2.distrito, item3.latitud, item3.longitud,
#                                         item3.humedad, item3.temperatura, item3.concentracion, item3.hora, item3.fecha, item.calidadAVG)
...
#     datoCalidad = DatoCalidad(dato.id, dato.Humedad, dato.Temperatura, dato.Calor, dato.Concentracion,
#                               dato.Latitud, dato.Longitud, dato.SensorHumo, dato.SensorMetano, dato.fecha, obtenerCalidad(dato))
